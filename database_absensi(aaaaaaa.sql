...
--
-- Host: localhost
-- Waktu pembuatan: 03 Jun 2025 pada 13.36
-- Versi server: 8.0.30
-- Versi PHP: 8.2.21
...
(1, 9, 'Ganjil', '2024-07-08', '2024-12-20', 0, '2025-03-25 17:10:01', '2025-05-29 09:53:14'),
(2, 9, 'Genap', '2025-01-06', '2025-06-26', 1, '2025-03-25 17:10:01', '2025-05-29 09:53:05');
...
('68299bcf4ba67', 9, 2, 8, 200000.00, '2025-05-18 08:35:27', '2025-05-26 07:30:35'),
('682a926307b1a', 9, 2, 9, 200000.00, '2025-05-19 02:07:31', '2025-05-26 07:30:44'),
('6834132eb1a87', 9, 2, 10, 200000.00, '2025-05-26 07:07:26', '2025-05-26 07:30:52');
...
ALTER TABLE `payments`
  ...
  ADD KEY `id_student` (`id_student`),
  ADD KEY `academic_year_id` (`academic_year_id`),
  ADD KEY `fk_payments_semester` (`semester_id`);
...
ALTER TABLE `spp`
  ADD PRIMARY KEY (`id`),
  ADD KEY `academic_year_id` (`academic_year_id`),
  ADD KEY `fk_spp_semester` (`semester_id`);
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `fk_payments_semester` FOREIGN KEY (`semester_id`) REFERENCES `semesters` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
--
ALTER TABLE `spp`
  ADD CONSTRAINT `fk_spp_semester` FOREIGN KEY (`semester_id`) REFERENCES `semesters` (`id`) ON DELETE SET NULL;
